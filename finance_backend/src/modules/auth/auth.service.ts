...
import SessionModel from "../../databse/models/session.model";
import UserModel from "../../databse/models/user.model";
import VerificationCodeModel from "../../databse/models/verification.model";
...
export class AuthService {
  public async register(registerData: RegisterDto) {
    const { firstName, lastName, email, password, address1, city, state, postalCode, ssn, dateOfBirth } = registerData;
